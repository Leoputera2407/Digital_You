...
from digital_twin.utils.slack import format_openai_to_slack, format_slack_to_openai
...
def respond_to_app_mention(
    ...
    try:
        ...
        messages.append(f"<@{context.bot_user_id}>: " + format_slack_to_openai(msg_text))
        ...
        client.chat_postEphemeral(channel=context.channel_id, text=text, thread_ts=payload["ts"])
