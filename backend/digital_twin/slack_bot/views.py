        ...
        if is_edit_view:
            ...
            edit_section = {
                ...
                "element": {
                    ...
                    "multiline": True,
                    "initial_value": metadata_dict[
                        "rephrased_response"
                    ],  # set the initial value to rephrase response
                },
                "label": {
                    "type": "plain_text",
                    ...
                    "elements": [
                        {
                            ...
                            "text": {
                                "type": "plain_text",
                                "text": ":twisted_rightwards_arrows: Shuffle",
                                "emoji": True,
                            },
    ...
    blocks = [
        {
            ...
            "text": {
                "type": "mrkdwn",
                "text": f"{m['sender']}: {json.loads(cast(str, button['value']))['message']}",  # The question is displayed here
            },
            "accessory": button,
        }
