...
from digital_twin.config.app_config import PROMPTLAYER_API_KEY
...
def get_llm(
    ...
    callback_handler: Optional[AsyncIteratorCallbackHandler] = [PromptLayerCallbackHandler(pl_tags=["Azure"])],
    **kwargs,
    ...
    if not PROMPTLAYER_API_KEY:
        raise ValueError("API key wasn't set for PromptLayer")
