                    ...
                    <div className="mb-5">
                      <div>
                        ...
                        <p className="text-slate-400">
                          It is hard work converting your podcasts to tiktok. We solve that.{" "}
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <div className="relative pb-12 md:pb-20">
            ...
            <Highlighter className="grid md:grid-cols-3 gap-6 group grid-auto-rows minmax(100px, auto)">
              <FeatureBox
                ...
                imageAlt="Enhanced Content Creation"
              />
              <FeatureBox
                title="Smart Automation"
                description="Prosona utilize advanced algorithms to extract the most impactful snippets from your long-form content."
                imageSrc={FeatureImg02}
                imageAlt="Smart Automation"
              />
              <FeatureBox
                title="Maximize Your Reach"
                description="Prosona optimizes your content strategy, helping you reach more followers with less effort."
                imageSrc={FeatureImg03}
                imageAlt="Maximize Your Reach"
              />
              <FeatureBox
                title="Creative Insights"
                description="The tool promotes documentation, providing analytics to gain insights into what content resonates with your audience."
                imageSrc={FeatureImg04}
                imageAlt="Creative Insights"
              />
              <FeatureBox
                title="Content Control"
                description="Prosona increases accountability by allowing creators to maintain control over the content narrative and quality."
                imageSrc={FeatureImg05}
                imageAlt="Content Control"
              />
              <FeatureBox
                title="Seamless TikTok Integration"
                description="Prosona offers a seamless integration experience, easily integrating with your TikTok workflow for a smooth content creation experience."
                imageSrc={FeatureImg06}
                imageAlt="Seamless TikTok Integration"
              />
            </Highlighter>
          </div>
        </div>
